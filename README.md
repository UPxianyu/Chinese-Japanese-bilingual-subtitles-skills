...
使用前请提供演唱会背景，例如歌手/团体、场次、日期或官方歌单，便于整理 setlist，并在翻译时统一专有名词。

> 这是 XX 演唱会（歌手/团体、场次、日期）。我会先提供歌单；请帮我在 XX 公开网站查询下载歌词。然后帮我给 `E:\videos\live.mp4` 做中日双语字幕，范围 `01:02:00` 到 `02:57:00`。翻译时请统一专有名词，先按歌曲分段输出给我审核，确认后再整合成完整成片。
